...
# Добро пожаловать в ~~мир боли~~ GIT!

Что такое git для чего нужен?
Git — система управления версиями с распределенной архитектурой. В отличие от некогда популярных систем вроде CVS и Subversion (SVN), где полная история версий проекта доступна лишь в одном месте, в Git каждая рабочая копия кода сама по себе является репозиторием. Что дает возможность восстановления проекта в случае выхода из строя одного из мест хранения проекта.
Git'ом можно управлять через программу или через командную строку(часто называют также консолью или терминалом). 
В данном случае вся ниже приведенная инфоррмация написана для работы с командной строкой.

**Настройка GIT**

Чтобы при участии в групповом проекте было видно кто и какие изменения вносил необходимо представиться и указать имя пользователя и адрес электронной почты.
git config --global user.name "Ваше имя латиницей и в кавычках"

git config --global user.email username@yandex.ru

Для проверки настроек можно воспользоваться командами:
